                        ...
                        <div class="box-body">
                            <div class="box box-info">
                                <div class="box-header">
                                    ...
                                    <h3 class="box-title">Edit Page Texts</h3>
                                    <!-- tools box -->
                                ...
                                <div class="box-body">
                                    <form action="#" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                               <label class="control-label">Select Page</label>
                                                ...
                                                <label class="control-label">Select Text Heading</label>
                                                <select name="menu1" onChange="">
                                                    <option value="" selected="selected" class="form-control">***Select One***</option>
                                                    <option value="manage-pages.php?type=terms">terms and condition</option>
                                                    <option value="manage-pages.php?type=privacy">privacy and policy</option>
                                                ...
                                                <label class="control-label">Select Text ID</label>
                                                <select name="menu1" onChange="">
                                                    <option value="" selected="selected" class="form-control">***Select One***</option>
                                                    <option value="manage-pages.php?type=terms">terms and condition</option>
                                                    <option value="manage-pages.php?type=privacy">privacy and policy</option>
                                        ...
                                        <div>
                                            <textarea class="textarea" placeholder="Message" style="width: 100%; height: 400px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                        </div>
                                    </form>
                                </div>
